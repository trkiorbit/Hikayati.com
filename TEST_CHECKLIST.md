...
## 🔄 Public Library Content — Pipeline الجديد (2026-04-24)

**القرار:** إنتاج القصص **خارج التطبيق** عبر Content Studio.

**ليس من اختبارات التطبيق** — عملية منفصلة موثّقة في:
- `content_studio/public_library/README_PUBLIC_LIBRARY_CONTENT_PIPELINE.md`
- `content_studio/public_library/QC_CHECKLIST.md` (فحص جودة كل قصة قبل النقل)

**الاختبارات المُطبّقة على القصص بعد النقل إلى `public_stories`:**
- [ ] حساب جديد (رصيد 20 ⭐)
- [ ] فتح المكتبة العامة
- [ ] القصص الخمس تظهر بـ covers واضحة
- [ ] الضغط على قصة → AlertDialog "خصم 10 ⭐"
- [ ] بعد القبول: خصم 10 → رصيد يصبح 10
- [ ] القصة تفتح في السينما بكل المشاهد (6)
- [ ] الصوت يعمل لكل مشهد
- [ ] إعادة فتح نفس القصة لاحقاً → **صفر خصم**
