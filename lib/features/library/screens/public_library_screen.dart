  ...
  Future<void> _purchaseAndReadStory(Map<String, dynamic> story) async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('هل تريد فتح قصة "${story['title']}" مقابل $price جواهر؟'),
        actions: [
          TextButton(onPressed: () => Navigator.pop(context, false), child: const Text('إلغاء')),
          ElevatedButton(onPressed: () => Navigator.pop(context, true), child: const Text('نعم، افتحها')),
        ],
      )
    );
    ...
    try {
      // Deduct Credits
      await SupabaseService.deductCredits(price, 'Purchase public story: ${story['id']}');
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('تم فتح القصة بنجاح!'), backgroundColor: AppColors.success),
        );
                          ...
                          children: [
                            Expanded(
                              child: story['cover'] != null
                                  ...
                                  : Container(color: AppColors.primary, child: const Icon(Icons.menu_book, size: 50, color: Colors.white)),
                            ),
                            Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      const Icon(Icons.diamond, size: 16, color: AppColors.secondary),
